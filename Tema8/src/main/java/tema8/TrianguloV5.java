 ...
 */
public class TrianguloV5 extends Figura2D_V5 {

    public String estilo;

    public TrianguloV5(double ancho, double alto, String estilo) {
        this();
        setAlto(alto);
        setAncho(ancho);
        this.estilo = estilo;
...
//AÑADIDA ESTA LINEA
    ...
    public TrianguloV5(double ancho, double alto) {
        super(ancho, alto);
    }
    ...
    public TrianguloV5(double dimension) {
        super(dimension);
    }
    ...
    public TrianguloV5(String estilo, double ancho, double alto) {
        super(ancho, alto);
        this.estilo = estilo;
    }
