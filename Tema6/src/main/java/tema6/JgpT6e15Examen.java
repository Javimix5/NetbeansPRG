...
System.out.println("Introduce as respotas do alumno. Tenen que ser 20. Emprega x para marcar as preguntas non contestadas.");
String respostasAlumno = teclado.nextLine();
while (!exame.checkFormat(respostasAlumno)) {
    System.out.println("O formato das respostas non e correcto. Introducela de novo.");
    respostasAlumno = teclado.nextLine();
}
System.out.printf("Nota do alumno: %.2f", exame.calcularNota(respostasAlumno));
    }
}
